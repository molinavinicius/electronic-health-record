...
export class CreateDB1690738365687 implements MigrationInterface {
    name = 'CreateDB1690738365687'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE "health_record" ("id" integer PRIMARY KEY AUTOINCREMENT NOT NULL, "evolution" varchar NOT NULL, "createdAt" datetime NOT NULL DEFAULT (datetime('now')), "updatedAt" datetime NOT NULL DEFAULT (datetime('now')), "patientId" integer, "appointmentId" integer, CONSTRAINT "REL_0a7486e7571808c07835f1deef" UNIQUE ("patientId"), CONSTRAINT "REL_029901e67c4cd020978cfada69" UNIQUE ("appointmentId"))`);
        ...
        await queryRunner.query(`CREATE TABLE "temporary_health_record" ("id" integer PRIMARY KEY AUTOINCREMENT NOT NULL, "evolution" varchar NOT NULL, "createdAt" datetime NOT NULL DEFAULT (datetime('now')), "updatedAt" datetime NOT NULL DEFAULT (datetime('now')), "patientId" integer, "appointmentId" integer, CONSTRAINT "REL_0a7486e7571808c07835f1deef" UNIQUE ("patientId"), CONSTRAINT "REL_029901e67c4cd020978cfada69" UNIQUE ("appointmentId"), CONSTRAINT "FK_0a7486e7571808c07835f1deeff" FOREIGN KEY ("patientId") REFERENCES "patient" ("id") ON DELETE NO ACTION ON UPDATE NO ACTION, CONSTRAINT "FK_029901e67c4cd020978cfada696" FOREIGN KEY ("appointmentId") REFERENCES "patient" ("id") ON DELETE NO ACTION ON UPDATE NO ACTION)`);
